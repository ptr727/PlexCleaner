...
public partial class HandBrake
{
    ...
    {
        IHandBrakeBuilder OutputOptions(Action<OutputOptions> outputOptions);
    }

    public interface IHandBrakeBuilder
    {
        Command Build();
    }

    public class HandBrakeBuilder(string targetFilePath)
            ...
            IHandBrakeBuilder
    {
        public static IGlobalOptions Create(string targetFilePath) =>
            new HandBrakeBuilder(targetFilePath);

        public static Command Version(string targetFilePath) =>
            new HandBrakeBuilder(targetFilePath).WithArguments(args =>
        ...
        public IHandBrakeBuilder OutputOptions(Action<OutputOptions> outputOptions)
        {

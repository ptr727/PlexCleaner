...
```text
PlexCleaner: 3.1.64+aae790c2d8 16:00:01 [INF] <1> Exit Code : 0
dotNET: 7.0.304
...
```text
PlexCleaner: 3.1.64+aae790c2d8 15:59:43 [INF] <1> Exit Code : 0
dotNET: 7.0.304
...
```text
PlexCleaner: 3.1.64+aae790c2d8 15:59:28 [INF] <1> Exit Code : 0
dotNET: 7.0.304
HandBrakeCLI: HandBrake 1.6.1
MediaInfo: MediaInfo Command line, MediaInfoLib - v23.04
MkvMerge: mkvmerge v77.0 ('Elemental') 64-bit
...
```text
PlexCleaner: 3.1.64+aae790c2d8 15:59:50 [INF] <1> Exit Code : 0
dotNET: 7.0.105
HandBrakeCLI: HandBrake 1.6.1
MediaInfo: MediaInfo Command line, MediaInfoLib - v23.04
MkvMerge: mkvmerge v77.0 ('Elemental') 64-bit

...
```text
PlexCleaner: 3.1.18+bbb385069a 03:42:26 [INF] <1> Exit Code : 0
dotNET: 7.0.302
...
```text
PlexCleaner: 3.1.18+bbb385069a 03:42:15 [INF] <1> Exit Code : 0
dotNET: 7.0.302
...
```text
PlexCleaner: 3.1.18+bbb385069a 03:41:56 [INF] <1> Exit Code : 0
dotNET: 7.0.302
HandBrakeCLI: HandBrake 1.6.1
MediaInfo: MediaInfo Command line, MediaInfoLib - v23.04
MkvMerge: mkvmerge v76.0 ('Celebration') 64-bit
...
```text
PlexCleaner: 3.1.18+bbb385069a 03:42:27 [INF] <1> Exit Code : 0
dotNET: 7.0.103
HandBrakeCLI: HandBrake 1.6.1
MediaInfo: MediaInfo Command line, MediaInfoLib - v23.04
MkvMerge: mkvmerge v76.0 ('Celebration') 64-bit

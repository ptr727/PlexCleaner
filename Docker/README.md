...
```text
PlexCleaner: 3.0.152+c8a0147c25 01:06:43 [INF] <1> Exit Code : 0
dotNET: 7.0.203
...
```text
PlexCleaner: 3.0.152+c8a0147c25 01:06:36 [INF] <1> Exit Code : 0
dotNET: 7.0.203
...
```text
PlexCleaner: 3.0.152+c8a0147c25 01:06:08 [INF] <1> Exit Code : 0
dotNET: 7.0.203
HandBrakeCLI: HandBrake 1.6.1
MediaInfo: MediaInfo Command line, MediaInfoLib - v23.04

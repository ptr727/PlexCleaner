...
# docker buildx build --load --platform linux/amd64 --tag plexcleaner:ubuntu --file ./Docker/Ubuntu.Rolling.Dockerfile .
# docker run -it --rm --name PlexCleaner-Test plexcleaner:ubuntu /bin/bash

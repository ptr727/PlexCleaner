...
public class VersionParsingTests(PlexCleanerFixture fixture)
{
    ...
    [InlineData(
        "ffprobe version 4.3.1-2020-11-19-full_build-www.gyan.dev Copyright (c) 2000-2020 the FFmpeg developers",
        "4.3.1"
    )]
    [InlineData(
        "ffprobe version 4.3.1-1ubuntu0~20.04.sav1 Copyright (c) 2000-2020 the FFmpeg developers",
        "4.3.1"
    )]
